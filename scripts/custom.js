...
$(document).ready(function(){
	...
	$('.go-close').click(function(){
		$('#nav0').delay(1500).toggle(100);
		$('#nav1').delay(1400).toggle(100);
		$('#nav2').delay(1300).toggle(100);
		$('#nav3').delay(1200).toggle(100);
		$('#nav4').delay(1100).toggle(100);
		$('#nav5').delay(1000).toggle(100);
		$('#nav6').delay(900).toggle(100);
		$('#nav7').delay(800).toggle(100);
		$('#nav8').delay(700).toggle(100);
		$('#nav9').delay(600).toggle(100);
		$('#nav10').delay(500).toggle(100);
		$('#nav11').delay(400).toggle(100);
		$('#nav12').delay(300).toggle(100);
		$('#nav13').delay(200).toggle(100);
		$('#nav14').delay(100).toggle(100);
